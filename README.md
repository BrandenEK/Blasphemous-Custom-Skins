...
3. Download the collection of custom skins from the [Releases](https://github.com/BrandenEK/Blasphemous-Custom-Skins/releases) page
4. Extract the contents of this zip file into the "Modding/skins" folder
